     ...
     public Object getClientData() {
        return clientData;
           ...
           public void receiveResultlistar(
                    br.com.fiap.bo.ProdutoBOStub.ListarResponse result
                        ) {
           }
           ...
           */
           ...
           /**
            * auto generated Axis2 call back method for buscarPorId method
            * override this method for handling normal response from buscarPorId operation
            */
           public void receiveResultbuscarPorId(
                    br.com.fiap.bo.ProdutoBOStub.BuscarPorIdResponse result
                        ) {
           }

          /**
           * auto generated Axis2 Error handler
           * override this method for handling error response from buscarPorId operation
           */
            public void receiveErrorbuscarPorId(java.lang.Exception e) {
            }
