		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					...
					JOptionPane.showMessageDialog(null, "Falha ao cadastrar usuário - " + erro.getMessage());
				}
		...
		btnApagar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					JOptionPane.showMessageDialog(null, "Falha ao apagar usuário - " + erro.getMessage());
				}
		...
		btnListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try{
					...
					JOptionPane.showMessageDialog(null, "Falha ao listar usuários - " + erro.getMessage());
				}
